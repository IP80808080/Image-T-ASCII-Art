...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'K:\Projects\Programming\Python\Project\Image and Python\Convert Image into ASCII Art'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'K:\Projects\Programming\Python\Project\Image and Python\Convert Image into ASCII Art\Scripts\deactivate.nu'
